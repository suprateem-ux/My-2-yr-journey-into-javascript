...
# README for Remix: Check if a number is prime or not #

This is the README file for the Remix: Check if a number is prime or not app. It's a great place to write
